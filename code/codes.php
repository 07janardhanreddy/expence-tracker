			...
			<div class="container">
				<nav class="navbar navbar-default">
					...
					<span class="icon-bar"></span>
						...
						<div class="logo">
							<h1><a class="navbar-brand" href="index.html"><span>E</span>xpenseTracker</a></h1>
						</div>
					</div>
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown menu__item active">
									...
									<ul class="dropdown-menu">
										<li><a href="codes.html">View Categorys</a></li>
										<li><a href="icons.html">Select Category</a></li>
									</ul>
								</li>
								
								<li><a href="contact.html" data-hover="Contact">Contact</a></li>
								<li><a href="contact.html" data-hover="Login/Signup">Login/Signup</a></li>
							</ul>
						</nav>
					</div>
					<!-- /.navbar-collapse -->
			...
			<div class="w3_agile_footer_grids">
				<div class="col-md-4 w3_agile_footer_grid">
					...
					<ul class="agile_footer_grid_list">
						<li><i class="fa fa-twitter" aria-hidden="true"></i>Expense management automation has two equally important aspects: the process an employee follows in order to complete an expense claim (for example, logging a hotel receipt or submitting mobile phone records) and the activity accounts or finance staff undertake to process the claim within the finance system.
