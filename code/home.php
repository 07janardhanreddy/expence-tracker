...
<body>
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown menu__item">
									...
									<ul class="dropdown-menu">
										<li><a href="loginindex.php">View Categorys</a></li>
										<li><a href="loginindex.php">Select Category</a></li>
									</ul>
								</li>
								
								<li><a href="contact.php" data-hover="Contact">Contact</a></li>

								<li><a href="loginindex.php" data-hover="loginindex.php">Login/Signup</a></li>
	...
	<div class="tax">
		<div class="container">
			<h3 class="title-txt">Expense Calculator</h3>
			...
			<p>Worth is expensive</p>
				...
				<div class="form-right-w3l">
						...
						<input type="text" class="top-up" name="name" placeholder="" required="">
				</div>
				<div class="clearfix"></div>
				<div class="form-left-w3l">
                ...
                <li>
                    <div class="wthree_testimonials_grid_main">
                        <div class="col-md-6 col-xs-6 wthree_testimonials_grid">
                            <p>
                                <img src="images/left-quote.png" alt=" "> Software Engineering ,Faculty.
                        ...
                        <div class="col-md-6 col-xs-6 wthree_testimonials_grid_pos">
                            <div class="col-md-5 col-xs-5 grid-test-w3l">
                                <img src="images/priyanka-vivek.jpg" alt=" " class="img-responsive" />
                            </div>
                            <div class="col-md-7 col-xs-7 wthree_testimonials_grid1">
                                <h5>priyanka-vivek</h5>
                                <p>Owner</p>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
	...
	<div class="footer">
		<div class="container">
			<div class="w3_agile_footer_grids">
				...
				<div class="col-md-4 w3_agile_footer_grid">
					<h3>Navigation</h3>
					<ul class="agileits_Team6_footer_grid_list">
						<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="home.php">Home</a></li>
